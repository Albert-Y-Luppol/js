(()=>{
    ...
    function preloadImg(){
        ...
        function isVisible(elem) {
            ...
            let bottomEdge = elem.offsetTop  < pageYOffset + 2 * document.documentElement.clientHeight,
                topEdge = elem.offsetTop + elem.offsetHeight  > pageYOffset - document.documentElement.clientHeight;

            console.log( bottomEdge + " : " + topEdge);
    ...
    function toTopBtn(){
        ...
        document.addEventListener('scroll', ()=>{
                arrow.hidden = pageYOffset  - document.documentElement.clientHeight < 0;
        })
    ...
    function infinityScroll(){
        ...
        document.addEventListener('scroll', fulfillPage);

        // functions

        function fulfillPage(e){

            while(document.body.clientHeight - pageYOffset - document.documentElement.clientHeight < 100){
        ...
        function addHTML(){
            document.body.insertAdjacentHTML('afterbegin', `<h1>Scroll me</h1>`);
        }
    }
})();